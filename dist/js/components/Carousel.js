app.component('carousel', {
  ...
  <div class="carousel-inner ">
    ...
    <div class="carousel-item" data-bs-interval="2000">
      <img src="./images/pizza-suprema.jpg" class="d-block mw-100 img-fluid opacity-75" style= "width:100%; height: 40rem" alt="...">
      <div class="carousel-caption text-light">
    ...
    <div class="carousel-item">
      <img src="./images/vodka-frutas.jpg" class="d-block img-fluid opacity-75"style= "width:100%; height: 40rem" alt="...">
      <div class="carousel-caption text-light ">
